...
if __name__ == "__main__":
    ...
    ROTATION = 17 # Угол поворота в градусах
    COLOR_PERCENT = 23# Интенсивность цвета (0-100%)
    ADD_COLOR = "фиолетовый"  # Цвет для добавления или 'False'
    WIDTH_PERCENT = 168 # Процент изменения ширины
